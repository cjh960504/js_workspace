/*
아래의 코드 단위는 사물 자체가 아니라, 장차 사물을 대량을 생산할 수 있는 틀이다!
그리고 전산분야에서는 이 틀을 가리켜 클래스라 부른다..
예) 붕어빵(객체, 인스턴스) - 붕어빵 형판(클래스)
...
class Arrow{
    ...
    // 대명사를 붙여야하며, this라는 이미 정해진 변수를 쓴다.
    // . : 소유권 '주체'의 '나'의

    // ES 2015년에 발표된 JS에 의해서, 클래스가 소유한 변수는 constructor() 라는 생성자 함수에 넣어줘여한다.
    // 속성 표기법 constructor(){this.속성명;}
    // constructor(){
    // }   
